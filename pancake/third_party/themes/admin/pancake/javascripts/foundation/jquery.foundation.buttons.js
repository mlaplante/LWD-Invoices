;(function ($, window, undefined) {
  ...
  $.fn.foundationButtons = function(options) {
    ...
    $doc.on('click.fndtn', '.button.dropdown, .button.dropdown.split span, .button.dropdown > span', function (e) {
    ...
    $doc.on('click.fndtn', '.button.dropdown.split span, .button.dropdown > span', function (e) {
      e.preventDefault();
