  ...
  update: requireRole("OWNER", "ADMIN")
    .input(
      z.object({
        ...
        earlyPayDiscountEnabled: z.boolean().optional(),
        earlyPayDiscountPercent: z.number().min(0).max(50).optional(),
        earlyPayDiscountDays: z.number().int().min(1).max(60).optional(),
