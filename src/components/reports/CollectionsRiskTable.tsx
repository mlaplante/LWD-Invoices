...
/**
 * Called with no input, matching the `api.analytics.collectionsRisk.prefetch()`
 * in the server page — same procedure, same (empty) input, so the query key
 * matches and this reads the hydrated cache instead of refetching on mount.
 */
export function CollectionsRiskTable() {
