...
export function AddUnmatchedPaymentDialog({
  open,
  onOpenChange,
}: {
  open: boolean;
      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <form onSubmit={submit} className="space-y-4">
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="unmatched-date">Received date</Label>
              <Input
                id="unmatched-date"
                type="date"
                value={receivedAt}
          ...
          <div className="space-y-1.5">
            <Label htmlFor="unmatched-method">Method</Label>
            <Select
              value={method}
              onValueChange={(value) => setMethod(value as typeof method)}
            >
              <SelectTrigger id="unmatched-method">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-1.5">
            <Label htmlFor="unmatched-payer">Payer name</Label>
            <Input
              id="unmatched-payer"
              value={payerName}
          ...
          <div className="space-y-1.5">
            <Label htmlFor="unmatched-reference">Reference</Label>
            <Input
              id="unmatched-reference"
              value={reference}
              onChange={(e) => setReference(e.target.value)}
              placeholder="Check number or transfer note"
            />
          </div>
          <div className="space-y-1.5">
          ...
          <DialogFooter>
            ...
            <Button
              ...
              aria-describedby={error ? "unmatched-payment-error" : undefined}
            >
