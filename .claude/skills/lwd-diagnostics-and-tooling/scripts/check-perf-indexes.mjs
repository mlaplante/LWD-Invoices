#!/usr/bin/env node
// MIRROR of the repo's canonical scripts/check-perf-indexes.mjs — kept here for
...
//   cp scripts/check-perf-indexes.mjs .claude/skills/lwd-diagnostics-and-tooling/scripts/
//
