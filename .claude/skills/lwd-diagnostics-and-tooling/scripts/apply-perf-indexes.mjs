#!/usr/bin/env node
// MIRROR of the repo's canonical scripts/apply-perf-indexes.mjs — kept here for
// offline reading only. Always run the copy at the repo root; if this drifts
// from it, the root copy is the source of truth. Re-sync with:
//   cp scripts/apply-perf-indexes.mjs .claude/skills/lwd-diagnostics-and-tooling/scripts/
//
